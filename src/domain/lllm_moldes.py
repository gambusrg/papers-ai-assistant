...
class ExtractorLLM(BaseModel):
    ...
    user_interest_points: list[str] = Field(description="User interest points in the paper")
    project_interest_points: list[str] = Field(description="Project interest points in the paper")
